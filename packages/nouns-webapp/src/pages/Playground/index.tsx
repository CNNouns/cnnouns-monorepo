...
const nounsProtocolLink = (
  <Link
    text={<Trans>CN Nouns Protocol</Trans>}
      ...
      <Container fluid="lg">
        <Row>
          <Col lg={10} className={classes.headerRow}>
            ...
            <p>
              <Trans>
                The playground was built using the {nounsProtocolLink}. CN Noun's traits are determined
                by the CN Noun Seed. The seed was generated using {nounsAssetsLink} and rendered using
                the {nounsSDKLink}.
              </Trans>
            </p>
          </Col>
