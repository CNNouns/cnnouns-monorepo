...
task('cnnouns-deploy-descriptor-v2', 'Deploy DescriptorV2 & populate it with art')
  .addParam(
    'daoExecutor',
  ...
  .setAction(async ({ daoExecutor, nftDescriptor, inflator, svgRenderer }, { ethers, run, network }) => {
