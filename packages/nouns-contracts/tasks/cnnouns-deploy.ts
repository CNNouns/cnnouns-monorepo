...
import { ChainId, ContractDeployment, ContractNameCNNouns, DeployedContract } from './types';
...
task('cnnouns-deploy', 'Deploys NFTDescriptor, NounsDescriptor, NounsSeeder, and NounsToken')
  ...
  .setAction(async (args, { ethers }) => {
    ...
    const deployment: Record<ContractNameCNNouns, DeployedContract> = {} as Record<
      ContractNameCNNouns,
      DeployedContract
    >;
    const contracts: Record<ContractNameCNNouns, ContractDeployment> = {
      NFTDescriptorV2: {},
      SVGRenderer: {},
      NounsDescriptorV2: {
